...
<%
  ...
  try{
    ...
    ResultSet r=stmt.executeQuery("select * from pagination where Person_id BETWEEN '5' and '6';");
...
%>
<div class="tab">
<a href="pagination_jsp.jsp">1</a>
  <a href="page-2.jsp">2</a>
  <a href="page-3.jsp">3</a>
</div>
</body>
</html>
